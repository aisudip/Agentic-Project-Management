...
class AugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        system_prompt = self.persona + 'You wil forget all previous conext'
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
        ...
        response_text = response.choices[0].message.content
        return  response_text # TODO: 4 - Return only the textual content of the response, not the full JSON payload.
...
class KnowledgeAugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        system_prompt = f"You are {self.persona} knowledge-based assistant. Forget all previous context. Use only the following knowledge to answer, do not use your own knowledge: {self.knowledge}.Answer the prompt based on this knowledge, not your own"
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
...
class RoutingAgent():
    ...
    def route_user_prompts(self, user_prompt):
        ...
        #print(best_agent["func"](user_input))
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        plan_system_prompt = (
            ...
            f"YForget any previous context. This is your knowledge: {self.knowledge}"
        )
