...
with open("phase_2/Product-Spec-Email-Router.txt", "r", encoding="utf-8") as file:
...
persona_product_evaluaion = "You are an evaluation agent that checks the answers of other worker agents."
...
max_interactions_product_eval = 10
product_manager_evaluation_agent = EvaluationAgent(openai_api_key, persona_product_evaluaion, product_evaluation_criteria, product_manager_knowledge_agent, max_interactions_product_eval)
...
max_interactions_program_eval = 10
program_manager_evaluation_agent = EvaluationAgent(openai_api_key, persona_program_manager_eval, program_evaluation_criteria, program_manager_knowledge_agent, max_interactions_program_eval) 
...
max_interactions_dev_eval = 10
development_engineer_evaluation_agent = EvaluationAgent(openai_api_key, persona_dev_engineer_eval, dev_evaluation_criteria, development_engineer_knowledge_agent, max_interactions_dev_eval) 
